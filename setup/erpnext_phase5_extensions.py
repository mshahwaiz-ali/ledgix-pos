...
CUSTOM_FIELDS = {
    "Item": [
        ...
        _cf(
            "custom_ledgix_legacy_tracking_type",
            "Data",
            "Legacy Tracking Type",
            insert_after="custom_ledgix_legacy_sku",
            read_only=1,
            description="Preserved even when the client profile intentionally uses non-stock ERPNext Items.",
        ),
        _cf(
            "custom_ledgix_minimum_stock",
            "Float",
            "Legacy Minimum Stock",
            insert_after="custom_ledgix_legacy_tracking_type",
            non_negative=1,
    ...
    "Item Group": [
        ...
        _cf(
            ...
            "Check",
            "Default Taxable",
            insert_after="custom_ledgix_legacy_default_tax_category_snapshot",
            default="1",
            hidden=1,
            read_only=1,
        ),
