...
DOCTYPE_PERMISSIONS = {
	...
	"Ledgix Tax Profile": _rows(_audit_read("System Manager"), _audit_read("Ledgix Admin"), _audit_read("Ledgix Manager")),
	"Ledgix Tax Category": _rows(_audit_read("System Manager"), _audit_read("Ledgix Admin"), _audit_read("Ledgix Manager")),
	"Ledgix Tax Rate": _rows(_audit_read("System Manager"), _audit_read("Ledgix Admin"), _audit_read("Ledgix Manager")),
	"Ledgix Item Tax Profile": _rows(_audit_read("System Manager"), _audit_read("Ledgix Admin"), _audit_read("Ledgix Manager")),
