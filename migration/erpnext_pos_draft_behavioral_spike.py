...
from ledgix_saas.migration import erpnext_pos_behavioral_spike_v2 as pos_v2
...
def _ensure_draft(customer: str, profile: str, warehouse: str):
    ...
    cash_account = pos_v2._payment_account(pos_base.PRIMARY_MODE, TEST_COMPANY)
            ...
            "payments": [
                {
                    ...
                    "type": pos_v2._payment_type(pos_base.PRIMARY_MODE),
                    "default": 1,
                }
            ],
        }
...
def run() -> dict:
    ...
    profile = pos_v2._ensure_pos_profile(customer, warehouse, cash_account)
